...
export default (state = INTIAL_STATE, action) => {
  switch (action.type) {
    ...
    case 'GET_CATEGORY':
      const allcategory = [...state.products.map((product) => { return { category: product.category } })]
    ...
    {
      return { ...state, Currentproducts: [...state.products.filter((product) => product.category === action.payload)] };
    }
    case 'ADD_PRODUCT':
